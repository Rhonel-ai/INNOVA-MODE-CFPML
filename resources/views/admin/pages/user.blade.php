...
<div class="alert text-bg-info-soft d-flex align-items-center mb-6" role="alert">
    ...
    <p class="mb-0">A private key <strong>should not be shared</strong> with anyone. Do not embed API keys directly in
        code. Do not store API keys in files inside your application's source tree. If you store API keys in files, keep
        the files outside your application's source tree to help ensure your keys do not end up in your source code
        control system. Delete unneeded API keys.</p>
</div>
                ...
                <table class="table align-middle table-hover table-nowrap mb-0">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>
                                <a href="javascript: void(0);" class="text-body-secondary list-sort" data-sort="key">
                                    API Key
                                </a>
                            </th>
                            <th>
                    ...
                    <tbody class="list">
                        <tr>
                            ...
                            <td class="key" data-key="FC6F7D6B-BADD-0DD4-A7B0-EB34A1EFA527">
                                <div class="d-flex">
                                    <input id="key-01" class="form-control w-350px me-3"
                                        value="FC6F7D6B-BADD-0DD4-A7B0-EB34A1EFA527">
                            ...
                            <td class="status" data-status="Active"><span class="legend-circle bg-success"></span>Active
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="0EDCEC27-5682-AB3A-9C4C-59DB1C21EE3E">
                                <div class="d-flex">
                                    <input id="key-02" class="form-control w-350px me-3"
                                        value="0EDCEC27-5682-AB3A-9C4C-59DB1C21EE3E">
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="C8F7062C-5D0A-73E2-683B-0082DA2A2931">
                                <div class="d-flex">
                                    <input id="key-03" class="form-control w-350px me-3"
                                        value="C8F7062C-5D0A-73E2-683B-0082DA2A2931">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-03"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                            ...
                            <td class="status" data-status="Inactive"><span
                                    class="legend-circle bg-warning"></span>Inactive</td>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="F45F2283-EF71-78D3-6266-A1A432CB68CA">
                                <div class="d-flex">
                                    <input id="key-04" class="form-control w-350px me-3"
                                        value="F45F2283-EF71-78D3-6266-A1A432CB68CA">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-04"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="DD16E1C1-4920-168B-9C03-AB89D2DC92E1">
                                <div class="d-flex">
                                    <input id="key-05" class="form-control w-350px me-3"
                                        value="DD16E1C1-4920-168B-9C03-AB89D2DC92E1">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-05"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                            ...
                            <td class="status" data-status="Disabled"><span
                                    class="legend-circle bg-danger"></span>Disabled</td>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="DCB6881B-DB20-1ADA-7F33-E1D77E1E5515">
                                <div class="d-flex">
                                    <input id="key-06" class="form-control w-350px me-3"
                                        value="DCB6881B-DB20-1ADA-7F33-E1D77E1E5515">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-06"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="92625B9D-A5ED-2C3C-3321-3F79617FC4E5">
                                <div class="d-flex">
                                    <input id="key-07" class="form-control w-350px me-3"
                                        value="92625B9D-A5ED-2C3C-3321-3F79617FC4E5">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-07"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="6AB6AB16-645C-03C9-EED1-C34EAF9F700A">
                                <div class="d-flex">
                                    <input id="key-08" class="form-control w-350px me-3"
                                        value="6AB6AB16-645C-03C9-EED1-C34EAF9F700A">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-08"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="CCBBE197-4FDC-23B1-D9BF-E5E306F25972">
                                <div class="d-flex">
                                    <input id="key-09" class="form-control w-350px me-3"
                                        value="CCBBE197-4FDC-23B1-D9BF-E5E306F25972">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-09"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="D09F3681-E6DF-4241-0EF5-C2CCE46498D4">
                                <div class="d-flex">
                                    <input id="key-10" class="form-control w-350px me-3"
                                        value="D09F3681-E6DF-4241-0EF5-C2CCE46498D4">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-10"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="AF9ABB15-4CA5-A714-B673-D4A62A6D855E">
                                <div class="d-flex">
                                    <input id="key-11" class="form-control w-350px me-3"
                                        value="AF9ABB15-4CA5-A714-B673-D4A62A6D855E">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-11"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="3BAF3B68-A425-ED34-982E-D57B3912B326">
                                <div class="d-flex">
                                    <input id="key-12" class="form-control w-350px me-3"
                                        value="3BAF3B68-A425-ED34-982E-D57B3912B326">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-12"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="394C9547-113E-EE50-9EB1-9C86B3AA05C2">
                                <div class="d-flex">
                                    <input id="key-13" class="form-control w-350px me-3"
                                        value="394C9547-113E-EE50-9EB1-9C86B3AA05C2">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-13"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="46A3284C-2C6D-1D1F-097A-82B67987C1E4">
                                <div class="d-flex">
                                    <input id="key-14" class="form-control w-350px me-3"
                                        value="46A3284C-2C6D-1D1F-097A-82B67987C1E4">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-14"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="4329C289-13AC-4EB1-6571-DD693F474730">
                                <div class="d-flex">
                                    <input id="key-15" class="form-control w-350px me-3"
                                        value="4329C289-13AC-4EB1-6571-DD693F474730">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-15"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="696B5CB-5D98-881A-7E4D-5367F5DA78DE">
                                <div class="d-flex">
                                    <input id="key-16" class="form-control w-350px me-3"
                                        value="696B5CB-5D98-881A-7E4D-5367F5DA78DE">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-16"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="F1E63894-45F0-5D37-3EA9-D99B3DB1CAE8">
                                <div class="d-flex">
                                    <input id="key-17" class="form-control w-350px me-3"
                                        value="F1E63894-45F0-5D37-3EA9-D99B3DB1CAE8">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-17"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="B0887A58-C385-D812-0C86-A18C7D6E3796">
                                <div class="d-flex">
                                    <input id="key-18" class="form-control w-350px me-3"
                                        value="B0887A58-C385-D812-0C86-A18C7D6E3796">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-18"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="AC04A2D7-8CCB-D9B1-879E-C3803AE8E3D1">
                                <div class="d-flex">
                                    <input id="key-19" class="form-control w-350px me-3"
                                        value="AC04A2D7-8CCB-D9B1-879E-C3803AE8E3D1">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-19"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="59C32E44-17C4-88F9-6456-2EEC982EE5CE">
                                <div class="d-flex">
                                    <input id="key-20" class="form-control w-350px me-3"
                                        value="59C32E44-17C4-88F9-6456-2EEC982EE5CE">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-20"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="D30D2527-6153-391D-F528-4F6827B2973E">
                                <div class="d-flex">
                                    <input id="key-21" class="form-control w-350px me-3"
                                        value="0D30D2527-6153-391D-F528-4F6827B2973E">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-21"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="504E63D5-C786-4995-CC33-26F80443FD2C">
                                <div class="d-flex">
                                    <input id="key-22" class="form-control w-350px me-3"
                                        value="504E63D5-C786-4995-CC33-26F80443FD2C">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-22"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="9C374A9F-1D14-B8E2-355F-7C33E38A136E">
                                <div class="d-flex">
                                    <input id="key-23" class="form-control w-350px me-3"
                                        value="C374A9F-1D14-B8E2-355F-7C33E38A136E">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-23"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="0CB8B7A1-939A-C53F-A3E2-98EA54718F79">
                                <div class="d-flex">
                                    <input id="key-24" class="form-control w-350px me-3"
                                        value="0CB8B7A1-939A-C53F-A3E2-98EA54718F79">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-24"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="D03374FA-822E-5C5E-D52C-297CE8E44A54">
                                <div class="d-flex">
                                    <input id="key-25" class="form-control w-350px me-3"
                                        value="D03374FA-822E-5C5E-D52C-297CE8E44A54">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-25"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="52ADE03F-56C7-5D43-41FE-7316A1F30D6C">
                                <div class="d-flex">
                                    <input id="key-26" class="form-control w-350px me-3"
                                        value="52ADE03F-56C7-5D43-41FE-7316A1F30D6C">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-26"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="4EDE4EE8-C1AC-4AA7-0481-67CF981D4400">
                                <div class="d-flex">
                                    <input id="key-27" class="form-control w-350px me-3"
                                        value="4EDE4EE8-C1AC-4AA7-0481-67CF981D4400">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-27"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
                        ...
                        <tr>
                            ...
                            <td class="key" data-key="4E18F6B4-5947-A001-EA41-155D7C9A0491">
                                <div class="d-flex">
                                    <input id="key-28" class="form-control w-350px me-3"
                                        value="4E18F6B4-5947-A001-EA41-155D7C9A0491">

                                    <!-- Button -->
                                    <button class="clipboard btn btn-link px-0" data-clipboard-target="#key-28"
                                        data-bs-toggle="tooltip" data-bs-title="Copy to clipboard">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18"
                                            width="18">
                                            <g>
