...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="text-center mb-5">
                        <div class="avatar avatar-xxl avatar-circle mb-5">
                            <form action="{{ route('users.upload',$user->id)}}" method="post"
                                ...
                                <label class="d-block cursor-pointer">
                                    ...
                                    <input type="file" name="upload" onchange="this.form.submit()" class="d-none">
                        ...
                        <span class="small text-secondary fw-semibold">@if(!empty($user->getRoleNames()))
            ...
            <div class="card border-0 scroll-mt-3" id="basicInformationSection">
                ...
                <form method="POST" action="{{route('profile.update')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3">
                                <label for="pays" class="col-form-label">Location</label>
                            </div>

                            <div class="col-lg">
                                <div class="mb-4">
                                    <select class="form-select" name="pays" id="country" required="" autocomplete="off"
                                        data-select='{
                                                        "placeholder": "Country"
                                                    }'
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3">
                                <label for="adresse" class="col-form-label">Address Line 1</label>
                            </div>
        ...
        <div class="card border-0 scroll-mt-3" id="usernameSection">
            ...
            <div class="card-body">
                <p class="small text-body-secondary mb-3">Your current username is
                    <strong>@ellietucker</strong>
                </p>
                        ...
                        <div class="col-lg">
                            <div class="input-group input-group-merge">
                                <input type="password" class="form-control" name="new_password" id="new_password"
                                    autocomplete="off" data-toggle-password-input="" placeholder="Your new password"
                                    required>
                                @error('new_password')
                                <div>{{$message}}</div>
                                @enderror
                        ...
                        <div class="col-lg">
                            <div class="input-group input-group-merge">
                                <input type="password" class="form-control" id="new_password_confirmation"
                                    name="new_password_confirmation" autocomplete="off" data-toggle-password-input=""
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="me-2">
                            ...
                            <p class="small text-body-secondary mb-0">Ut vel lectus vel sem pretium pharetra
                            </p>
                        </div>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="me-2">
                            ...
                            <p class="small text-body-secondary mb-0">Nunc suscipit est quis tincidunt
                                lobortis
                            </p>
                        </div>
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="me-2">
                            ...
                            <p class="small text-body-secondary mb-0">Nunc eget libero posuere, cursus mi
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-87.000000, -72.000000)">
                                        <g id="visa" transform="translate(75.000000, 50.000000)">
                                            <rect id="Rectangle-26" fill-opacity="0" fill="#FFFFFF" x="0" y="0"
                                                width="110" height="70"></rect>
                            ...
                            <div class="ms-4">
                                ...
                                <p class="small text-body-secondary mb-0">Expires 9/2024</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-94.000000, -152.000000)">
                                        <g id="mastercard" transform="translate(75.000000, 145.000000)">
                                            <rect id="Rectangle-26-Copy" fill-opacity="0" fill="#FFFFFF" x="0" y="0"
                                                width="110" height="70"></rect>
                            ...
                            <div class="ms-4">
                                ...
                                <p class="small text-body-secondary mb-0">Expires 7/2025</p>
                            </div>
                        </div>

                        <!-- Dropdown -->
                        <div class="dropdown">
                            <a href="javascript: void(0);" class="dropdown-toggle no-arrow d-flex mx-2 text-secondary"
        ...
        <div class="card border-0 scroll-mt-3" id="notificationsSection">
            ...
            <div class="card-body">
                <p class="text-body-secondary">In this setcion you will be able to configure the behaviour
                    of
                            ...
                            <tr>
                                ...
                                <th class="text-center text-uppercase py-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="24" width="24"
                                        ...
                                        <line class="a" x1="0.75" y1="3.75" x2="23.25" y2="3.75"></line>
                                        <rect class="a" x="0.75" y="13.75" width="22.5" height="9.5" rx="1">
                                        </rect>
                                        <line class="a" x1="0.75" y1="16.75" x2="23.25" y2="16.75"></line>
                                    </svg>
                                    Browser
                                </th>
                                <th class="text-center text-uppercase py-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="24" width="24"
                                        ...
                                        <line class="a" x1="18.374" y1="5.75" x2="21.374" y2="5.75"></line>
                                        <line class="a" x1="19.124" y1="10.75" x2="22.124" y2="10.75">
                                        </line>
                                        <line class="a" x1="20.124" y1="15.5" x2="23.124" y2="15.5"></line>
                                        <path class="a"
                                        ...
                                        <line class="a" x1="0.876" y1="18.75" x2="14.376" y2="18.75"></line>
                                    </svg>
                                    App
                                </th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <p class="small text-body-secondary mb-0">Lorem ipsum dolor sit amet</p>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="small text-body-secondary mb-0">Nunc suscipit est quis
                                        tincidunt
                                        lobortis</p>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="small text-body-secondary mb-0">Nunc eget libero posuere,
                                        cursus
                                        mi tincidunt, mattis nisi</p>
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-check-inline m-0">
                                        <input class="form-check-input" type="checkbox" checked="">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="small text-body-secondary mb-0">In dapibus magna ac tellus
                                        lacinia, tempus pretium mauris scelerisque</p>
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-check-inline m-0">
                                        <input class="form-check-input" type="checkbox" checked="">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="small text-body-secondary mb-0">Ut viverra sapien ut purus
                                        ultricies, et euismod enim viverra</p>
                                </td>
                                <td class="text-center">
                                    <div class="form-check form-check-inline m-0">
                                        <input class="form-check-input" type="checkbox">
        ...
        <div class="card border-0 scroll-mt-3" id="connectedAccountsSection">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Etiam rhoncus leo et ex volutpat
                                    eleifend</p>
                            </div>
                        </div>
                        <div class="form-check form-switch mb-0">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                            <svg width="32" height="32" viewbox="0 0 256 249" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Vestibulum egestas erat nec nisl
                                    commodo egestas</p>
                            </div>
                        </div>
                        <div class="form-check form-switch mb-0">
                        ...
                        <div class="d-flex align-items-center">
                            <svg height="32" viewbox="2.59 0 214.09101008 224" width="32"
                                ...
                                <lineargradient gradienttransform="matrix(1 0 0 -1 0 264)"
                                    gradientunits="userSpaceOnUse" x1="102.4" x2="56.15" y1="218.63" y2="172.39">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Maecenas sit amet nibh iaculis, <a
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Lorem ipsum dolor sit amet,
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Fusce at sem viverra, scelerisque
                                    justo ac, dapibus libero</p>
                            </div>
                        </div>
                        <div class="form-check form-switch mb-0">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <p class="small text-body-secondary mb-0">Sed dapibus sapien <a
                                        href="javascript: void(0);">vel
                                        bibendum</a> egestas</p>
                            </div>
                        </div>
                        <div class="form-check form-switch mb-0">
