...
<div class="container-fluid">
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-auto d-flex ms-auto ms-md-0">
                                    <div class="avatar avatar-circle avatar-xxl">
                                        @if($user->upload)
                                        <img src=" {{ asset('storage/uploads/'.$user->upload) }}" alt="profil"
                                            width="112" height="112" class="rounded-circle" style="object-fit:cover;">
                                        @else
                                ...
                                <div class="col-auto me-auto d-flex flex-column">
                                    ...
                                    <span
                                        class="small text-secondary fw-bold d-block mb-4">@if(!empty($user->getRoleNames()))
        ...
        <div class="col-xl-3 d-flex">
            ...
            <div class="card border-0 flex-fill w-100">
                <div class="card-body text-center">
                    <div class="row align-items-center h-100">
                        <div class="col">
                            <small class="text-secondary">Nombre utilisateur</small>
    ...
    <ul class="nav nav-tabs" id="userTab">
        <li class="nav-item" role="presentation">
            <a href="javascript: void(0);" class="nav-link active" id="profile-tab" data-bs-toggle="tab"
                data-bs-target="#profile" role="tab" aria-controls="profile" aria-selected="true">
                Profile
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="javascript: void(0);" class="nav-link" id="projects-tab" data-bs-toggle="tab"
                data-bs-target="#projects" role="tab" aria-controls="projects" aria-selected="false">
                Projects
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="javascript: void(0);" class="nav-link d-flex align-items-center" id="connections-tab"
                data-bs-toggle="tab" data-bs-target="#connections" role="tab" aria-controls="connections"
                aria-selected="false">
                Connections
                <span
                    class="badge text-bg-dark-soft rounded-circle d-inline-flex align-items-center justify-content-center w-20px h-20px ms-1">4</span>
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a href="javascript: void(0);" class="nav-link" id="files-tab" data-bs-toggle="tab" data-bs-target="#files"
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <ul class="list-unstyled mb-7">
                                <li class="py-2">
                                    <svg viewbox="0 0 24 24" height="18" width="18" class="me-2"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.476,23.25a10.483,10.483,0,0,0-18.952,0" fill="none"
                                ...
                                <li class="py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" height="18"
                                        ...
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5" d="M8.25 3.519V20.019"></path>
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5" d="M15.75 0.75V8.25"></path>
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5"
                                ...
                                <li class="py-2">
                                    <svg viewbox="0 0 24 24" height="18" width="18" class="me-2"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.5 23.25L1.5 8.25 10.5 8.25 10.5 23.25" fill="none"
                                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5"></path>
                                        <path d="M4.5 23.25L4.5 11.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M7.5 23.25L7.5 11.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M1.5 8.25L6 3 10.5 8.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M6 0.75L6 3" fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path
                                            d="M22.5,23.25V11.041a.751.751,0,0,0-.513-.712l-7.5-2.5a.749.749,0,0,0-.987.712V23.25"
                                            fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M19.5 21L19.5 21.75" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M19.5 17.25L19.5 18" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M19.5 13.5L19.5 14.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M16.5 21L16.5 21.75" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M16.5 17.25L16.5 18" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M16.5 13.5L16.5 14.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                    </svg>
                                    {{$user->adresse}}
                                </li>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="py-2">
                                    <svg viewbox="0 0 24 24" height="18" width="18" class="me-2"
                                        ...
                                        <path
                                            ...
                                            fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M8.249,23.25a4.25,4.25,0,0,0-7.5,0" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path
                                            d="M16.874 17.625 A2.625 2.625 0 1 0 22.124 17.625 A2.625 2.625 0 1 0 16.874 17.625 Z"
                                            fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M23.249,23.25a4.25,4.25,0,0,0-7.5,0" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path
                                            d="M9.374 3.375 A2.625 2.625 0 1 0 14.624 3.375 A2.625 2.625 0 1 0 9.374 3.375 Z"
                                            fill="none" stroke="currentColor" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M15.248,8.25a4.269,4.269,0,0,0-6.5,0" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M9.05,19.707a8.277,8.277,0,0,0,5.944-.018" fill="none"
                                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5"></path>
                                        <path d="M6.348,6a8.217,8.217,0,0,0-2.6,6c0,.253.015.5.038.75" fill="none"
                                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="1.5"></path>
                                ...
                                <li class="py-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="18" width="18"
                                        ...
                                        <rect class="a" x="0.75" y="1.25" width="22.5" height="21.5" rx="1"></rect>
                                        <line class="a" x1="8.75" y1="1.25" x2="8.75" y2="22.75"></line>
                                        <line class="b" x1="3.25" y1="5.75" x2="6.25" y2="5.75"></line>
                                        <line class="b" x1="12.81" y1="10.577" x2="18.53" y2="10.577"></line>
                                        <line class="b" x1="3.25" y1="10.25" x2="6.25" y2="10.25"></line>
                                        <line class="b" x1="3.25" y1="14.75" x2="6.25" y2="14.75"></line>
                                        <rect class="c" x="12.81" y="4.275" width="5.72" height="3.5"></rect>
                                        <line class="b" x1="12.81" y1="19.986" x2="18.53" y2="19.986"></line>
                                        <rect class="c" x="12.81" y="13.75" width="5.72" height="3.5"></rect>
                                    </svg>
                ...
                <div class="col">
                    ...
                    <div class="card border-0">
                        <div class="card-header border-0 card-header-space-between">
                            ...
                            <a href="#projects" data-toggle="tabLink" class="small fw-bold">
                                View all
                            </a>
                        </div>
                        ...
                        <div class="col-12 col-xl">
                            ...
                            <div class="card border-0 flex-fill w-100">
                                <div class="card-header card-header-space-between">
                                    ...
                                    <!-- Link -->
                                    <a href="#connections" data-toggle="tabLink" class="small fw-bold">
                                        View all
                                    </a>
                                </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-circle avatar-xs avatar-busy me-2">
                                                            <img src="assets/images/profiles/profile-05.jpeg" alt="..."
                                                                class="avatar-img" width="30" height="30">
                                                        </div>

                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold d-block">Dylan Sutton</span>
                                                            <span class="fs-6 text-body-secondary">10 connections</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-state-switch float-end">
                                                        ...
                                                        <label class="form-state-label" for="connection1">
                                                            <span class="form-state-default">
                                                                <span
                                                                    class="d-flex align-items-center justify-content-center text-bg-light link-secondary rounded-circle w-30px h-30px">
                                                            ...
                                                            <span class="form-state-active">
                                                                <span
                                                                    class="d-flex align-items-center justify-content-center text-bg-primary ms-auto rounded-circle w-30px h-30px">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        viewbox="0 0 24 24" height="14" width="14">
                                                                        <path
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-circle avatar-xs avatar-online me-2">
                                                            <img src="assets/images/profiles/profile-07.jpeg" alt="..."
                                                                class="avatar-img" width="30" height="30">
                                                        </div>

                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold d-block">Lester William</span>
                                                            <span class="fs-6 text-body-secondary">83 connections</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-state-switch float-end">
                                                        <input class="form-state-input" type="checkbox"
                                                            id="connection2">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-circle avatar-xs me-2">
                                                            <img src="assets/images/profiles/profile-02.jpeg" alt="..."
                                                                class="avatar-img" width="30" height="30">
                                                        </div>

                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold d-block">Chloe Brewer</span>
                                                            <span class="fs-6 text-body-secondary">27 connections</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-state-switch float-end">
                                                        <input class="form-state-input" type="checkbox"
                                                            id="connection3">
                                                        <label class="form-state-label" for="connection3">
                                                            <span class="form-state-default">
                                                                <span
                                                                    class="d-flex align-items-center justify-content-center text-bg-light link-secondary rounded-circle w-30px h-30px">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-circle avatar-xs avatar-busy me-2">
                                                            <span class="avatar-title">IG</span>
                                                        </div>

                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold d-block">Irina Garcia</span>
                                                            <span class="fs-6 text-body-secondary">9 connections</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-state-switch float-end">
                                                        <input class="form-state-input" type="checkbox" id="connection4"
                                                            checked="">
                                                        <label class="form-state-label" for="connection4">
                                                            <span class="form-state-default">
                                                                <span
                                                                    class="d-flex align-items-center justify-content-center text-bg-light link-secondary rounded-circle w-30px h-30px">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-circle avatar-xs me-2">
                                                            <img src="assets/images/profiles/profile-12.jpeg" alt="..."
                                                                class="avatar-img" width="30" height="30">
                                                        </div>

                                                        <div class="d-flex flex-column">
                                                            <span class="fw-bold d-block">Javier Griffin</span>
                                                            <span class="fs-6 text-body-secondary">37 connections</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-check form-state-switch float-end">
                                                        <input class="form-state-input" type="checkbox"
                                                            id="connection5">
                                                        <label class="form-state-label" for="connection5">
                                                            <span class="form-state-default">
                                                                <span
                                                                    class="d-flex align-items-center justify-content-center text-bg-light link-secondary rounded-circle w-30px h-30px">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <table class="table table-sm table-borderless align-middle mb-3">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <svg width="23" height="30" class="me-3" viewbox="0 0 32 42"
                                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                                            <title>google-docs</title>
                                                            <g stroke="none" stroke-width="1" fill="none"
                                                                fill-rule="evenodd">
                                                                <g transform="translate(-143.000000, -703.000000)"
                                                                    fill-rule="nonzero">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-6 text-body-secondary">Updated 17 mins ago,
                                                                18 kb</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript: void(0);">
                                                                    <svg viewbox="0 0 24 24" height="14" width="14"
                                                                        class="me-2" xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript: void(0);">
                                                                    <svg viewbox="0 0 24 24" height="14" width="14"
                                                                        class="me-2" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M12.001 3.75L12.001 15.75" fill="none"
                                                                            stroke="currentColor" stroke-linecap="round"
                                                                            stroke-linejoin="round" stroke-width="1.5">
                                                                        </path>
                                                                        <path d="M7.501 11.25L12.001 15.75 16.501 11.25"
                                                                            fill="none" stroke="currentColor"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" stroke-width="1.5">
                                                                        </path>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript: void(0);">
                                                                    <svg viewbox="0 0 24 24" height="14" width="14"
                                                                        ...
                                                                        <path d="M15.425 16.845L19.075 14.655"
                                                                            fill="none" stroke="currentColor"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" stroke-width="1.5">
                                                                        </path>
                                                                        <path d="M15.588 18.835L18.912 20.165"
                                                                            fill="none" stroke="currentColor"
                                                                            stroke-linecap="round"
                                                                            stroke-linejoin="round" stroke-width="1.5">
                                                                        </path>
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript: void(0);">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        viewbox="0 0 24 24" height="12" width="14"
                                                                        class="me-2">
                                                                        <g>
                                                                            ...
                                                                            <line x1="9.75" y1="17.75" x2="9.75"
                                                                                y2="10.25"
                                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5">
                                                                            </line>
                                                                            <line x1="14.25" y1="17.75" x2="14.25"
                                                                                y2="10.25"
                                                                                style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5">
                                                                            </line>
                                                                            <path
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-6 text-body-secondary">Updated 32 mins ago,
                                                                32 kb</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <svg width="23" height="30" class="me-3" viewbox="0 0 32 42"
                                                            ...
                                                            <g stroke="none" stroke-width="1" fill="none"
                                                                fill-rule="evenodd">
                                                                <g transform="translate(-719.000000, -703.000000)"
                                                                    fill-rule="nonzero">
                                                                    <g transform="translate(29.000000, 595.000000)">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-6 text-body-secondary">Updated 2 days ago,
                                                                1.2 MB</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <svg width="23" height="30" class="me-3" viewbox="0 0 32 42"
                                                            ...
                                                            <g stroke="none" stroke-width="1" fill="none"
                                                                fill-rule="evenodd">
                                                                <g transform="translate(-1007.000000, -703.000000)"
                                                                    fill-rule="nonzero">
                                                                    <g transform="translate(29.000000, 595.000000)">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-6 text-body-secondary">Updated 3 days ago, 3
                                                                kb</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <svg width="23" height="30" class="me-3" viewbox="0 0 33 43"
                                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                                            <title>google-forms</title>
                                                            <g stroke="none" stroke-width="1" fill="none"
                                                                fill-rule="evenodd">
                                                                <g transform="translate(-431.000000, -915.000000)"
                                                                    fill-rule="nonzero">
                                                                    <g transform="translate(29.000000, 595.000000)">
                                                                        <g
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <span class="fs-6 text-body-secondary">Updated 18 days ago,
                                                                21 kb</span>
                                                        </div>
                                                    </div>
                                                </td>
        ...
        <div class="tab-pane fade" id="projects" role="tabpanel" aria-labelledby="projects-tab">
            <div class="row mb-6">
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        <div class="card-header border-0 card-header-space-between">
                            <span class="badge text-bg-info-soft flex-grow-0 flex-shrink-0 text-info p-2">In progress -
                                87%</span>

                            <!-- Dropdown -->
                            <div class="dropdown">
                                <a href="javascript: void(0);" class="dropdown-toggle no-arrow text-body-secondary"
                        ...
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg d-flex align-items-center mx-auto">
                            ...
                            <p class="fs-5 mb-1 text-body-secondary text-uppercase">Members</p>

                            <!-- Avatar group -->
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-01.jpeg" alt="..."
                                ...
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-info-soft border border-2 border-white">NB</span>
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-04.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-03.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-04.jpeg" alt="..."
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        <div class="card-header border-0 card-header-space-between">
                            <span class="badge text-bg-secondary-soft flex-grow-0 flex-shrink-0 text-secondary p-2">To
                                do</span>
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-06.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-dark-soft border border-2 border-white">EV</span>
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-07.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                ...
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-08.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-09.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-10.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-dark border border-2 border-white">VP</span>
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-11.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="avatar-group">
                                ...
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-13.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-14.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg d-flex align-items-center mx-auto">
                                <svg class="avatar-img w-75 mx-auto" enable-background="new 0 0 2447.6 2452.5"
                            ...
                            <div class="avatar-group">
                                ...
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-dark-soft border border-2 border-white">DF</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-dark-soft border border-2 border-white">PL</span>
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-15.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-10.jpeg" alt="..."
                ...
                <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <span class="avatar avatar-lg d-flex align-items-center mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="avatar-img" viewbox="0 0 352 352">
                                    <path d="M0 0h352v352H0V0z" fill="#fff"></path>
                                    <path
                            ...
                            <div class="avatar-group">
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-16.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <img src="assets/images/profiles/profile-17.jpeg" alt="..."
                                        class="avatar-img border border-2 border-white">
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-info border border-2 border-white">ZA</span>
                                </div>
                                <div class="avatar avatar-circle avatar-sm">
                                    <span class="avatar-title text-bg-danger border border-2 border-white">OJ</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-footer border-0">
                            <div class="progress w-100 h-5px">
                                <div class="progress-bar bg-info" role="progressbar" style="width: 36%"
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl avatar-circle avatar-busy">
                                <img src="assets/images/profiles/profile-04.jpeg" alt="..." class="avatar-img">
                            </div>

                            <!-- Title -->
                            <h3 class="card-title mt-3 mb-1">Perry Hart</h3>
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Project Manager</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Excel</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">JIRA</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Trello</a></li>
                            </ul>
                        </div>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" height="14"
                                                ...
                                                <g>
                                                    <path
                                                        d="M11.23,12.24a.49.49,0,0,0-.13-.76,7.37,7.37,0,0,0-3.64-1A7.55,7.55,0,0,0,.27,15.86a.5.5,0,0,0,.08.44.48.48,0,0,0,.4.2H8.89a.49.49,0,0,0,.49-.41A7.92,7.92,0,0,1,11.23,12.24Z"
                                                        style="fill: currentColor"></path>
                                                    <circle cx="7.25" cy="4.75" r="4.75" style="fill: currentColor">
                                                    </circle>
                                                    <path
                                                        d="M17.25,11a6.5,6.5,0,1,0,6.5,6.5A6.51,6.51,0,0,0,17.25,11Zm3.5,7.5h-2a.5.5,0,0,0-.5.5v2a1,1,0,0,1-2,0V19a.5.5,0,0,0-.5-.5h-2a1,1,0,0,1,0-2h2a.5.5,0,0,0,.5-.5V14a1,1,0,0,1,2,0v2a.5.5,0,0,0,.5.5h2a1,1,0,0,1,0,2Z"
                                                        style="fill: currentColor"></path>
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl avatar-circle avatar-online">
                                <img src="assets/images/profiles/profile-15.jpeg" alt="..." class="avatar-img">
                            </div>

                            <!-- Title -->
                            <h3 class="card-title mt-3 mb-1">Norma Peck</h3>
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Digital Producer</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Illustrator</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Sketch</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Figma</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-state-switch">
                                <input class="form-state-input" type="checkbox" id="connection7" checked="">
                ...
                <div class="col-lg-6 col-xl-4 col-xxl-3">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Accountant</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Quickbooks</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Xero</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-state-switch">
                                <input class="form-state-input" type="checkbox" id="connection8" checked="">
                ...
                <div class="col-lg-6 col-xl-4 col-xxl-3">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Designer</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Photoshop</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Figma</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Illustrator</a></li>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-state-switch">
                                <input class="form-state-input" type="checkbox" id="connection9">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <div class="avatar avatar-xl avatar-circle avatar-offline">
                                <img src="assets/images/profiles/profile-01.jpeg" alt="..." class="avatar-img">
                            </div>

                            <!-- Title -->
                            <h3 class="card-title mt-3 mb-1">Katie Fowler</h3>
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Secretary</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Word</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Excel</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-state-switch">
                                <input class="form-state-input" type="checkbox" id="connection10" checked="">
                ...
                <div class="col-lg-6 col-xl-4 col-xxl-3">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="fs-5 mb-6 text-body-secondary text-uppercase">Developer</p>
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">React</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Sass</a></li>
                                <li class="list-inline-item"><a class="badge text-bg-light p-2"
                                        href="javascript: void(0);">Vue.js</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-check form-state-switch">
                                <input class="form-state-input" type="checkbox" id="connection11">
        ...
        <div class="tab-pane fade" id="files" role="tabpanel" aria-labelledby="files-tab">
            <div class="row">
                <div class="col">
                    ...
                    <!-- Card -->
                    <div class="card border-0 flex-fill w-100" data-list=' {"valueNames": ["title", {"name": "updated" , "attr" : "data-updated" },
                                            {"name": "size" , "attr" : "data-size" }], "page" : 10}' id="filesTable">
                        <div class="card-header border-0">
                            ...
                            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-end">
                                ...
                                <input class="form-control list-search mw-md-300px ms-md-auto mt-5 mt-md-0 mb-3 mb-md-0"
                                    type="search" placeholder="Search in files">

                                <!-- Button -->
                                <button type="button" class="btn btn-primary ms-md-4" data-bs-toggle="modal"
                                    data-bs-target="#uploadFilesModal">
                                    <svg viewbox="0 0 24 24" height="16" width="16" class="me-1"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12 23.25L12 14.25" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path d="M8.25 18L12 14.25 15.75 18" fill="none" stroke="currentColor"
                                            stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
                                        <path
                            ...
                            <table class="table align-middle table-hover table-nowrap mb-0">
                                ...
                                <tbody class="list">
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Employee
                                                        handbook</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown float-end">
                                                <a href="javascript: void(0);"
                                                    class="dropdown-toggle no-arrow d-flex text-secondary" role="button"
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="javascript: void(0);">
                                                            <svg viewbox="0 0 24 24" height="14" width="14" class="me-2"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M12,5.251C7.969,5.183,3.8,8,1.179,10.885a1.663,1.663,0,0,0,0,2.226C3.743,15.935,7.9,18.817,12,18.748c4.1.069,8.258-2.813,10.824-5.637a1.663,1.663,0,0,0,0-2.226C20.2,8,16.031,5.183,12,5.251Z"
                                                                    fill="none" stroke="currentColor"
                                                        ...
                                                        <a class="dropdown-item" href="javascript: void(0);">
                                                            <svg viewbox="0 0 24 24" height="14" width="14" class="me-2"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="1.5"></path>
                                                                <path d="M15.425 16.845L19.075 14.655" fill="none"
                                                                    stroke="currentColor" stroke-linecap="round"
                                                                    stroke-linejoin="round" stroke-width="1.5"></path>
                                                                <path d="M15.588 18.835L18.912 20.165" fill="none"
                                                                    stroke="currentColor" stroke-linecap="round"
                                                                    stroke-linejoin="round" stroke-width="1.5"></path>
                                                                <path
                                                                    d="M8.25,20.25h-6a1.5,1.5,0,0,1-1.5-1.5V2.25A1.5,1.5,0,0,1,2.25.75H12.879a1.5,1.5,0,0,1,1.06.439l2.872,2.872a1.5,1.5,0,0,1,.439,1.06V8.25"
                                                        ...
                                                        <a class="dropdown-item" href="javascript: void(0);">
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24"
                                                                ...
                                                                <g>
                                                                    ...
                                                                    <line x1="9.75" y1="17.75" x2="9.75" y2="10.25"
                                                                        style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5">
                                                                    </line>
                                                                    <line x1="14.25" y1="17.75" x2="14.25" y2="10.25"
                                                                        style="fill: none;stroke: currentColor;stroke-linecap: round;stroke-linejoin: round;stroke-width: 1.5">
                                                                    </line>
                                                                    <path
                                                                        d="M18.86,21.62A1.49,1.49,0,0,1,17.37,23H6.63a1.49,1.49,0,0,1-1.49-1.38L3.75,5h16.5Z"
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Digital Media
                                                        2022</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Brand
                                                        advertising</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size" data-size="1258291">
                                            1.2 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="size" data-size="3460300">
                                            3.3 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Figma for
                                                        beginners</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size" data-size="103424">
                                            101 kb
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="size" data-size="2516582">
                                            2.5 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">How to make your
                                                        business
                                                        successful?</span>
                                                </div>
                                            </div>
                                        ...
                                        <td class="size" data-size="7340032">
                                            7 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Annual report
                                                        2019</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="size" data-size="2097152">
                                            2 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="size" data-size="2726297">
                                            2.6 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Reference
                                                        letter</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size" data-size="4299161">
                                            4.1 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Bootstrap Themes
                                                        doc</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Main website
                                                        amends</span>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="title">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <span class="fw-bold d-block">Automated speedtest
                                                        results</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="size" data-size="3984588">
                                            3.8 MB
                                        </td>
                                        <td>
                                            <!-- Dropdown -->
