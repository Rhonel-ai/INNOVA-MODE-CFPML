 ...
 <header class="container-fluid d-flex py-6 mb-4">
     ...
     <form class="d-none d-md-inline-block me-auto">
         <div class="input-group input-group-merge">
             ...
             <!-- Input -->
             <input type="text" class="form-control bg-light-green border-light-green w-250px" placeholder="Search..."
                 ...
                 <button class="btn btn-primary rounded-2 w-30px h-30px p-0 mx-1" type="button"
                     ...
                     <svg viewbox="0 0 24 24" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
                         <path d="M0.750 9.812 A9.063 9.063 0 1 0 18.876 9.812 A9.063 9.063 0 1 0 0.750 9.812 Z"
                             ...
                             stroke-width="1.5" transform="translate(-3.056 4.62) rotate(-23.025)"></path>
     ...
     <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
             ...
             <ul class="dropdown-menu dropdown-menu-end">
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item active">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/us.svg" alt="..." width="18" height="18"></span><span
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/gb.svg" alt="..." width="18" height="18"></span><span
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/es.svg" alt="..." width="18" height="18"></span><span
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/fr.svg" alt="..." width="18" height="18"></span><span
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/de.svg" alt="..." width="18" height="18"></span><span
                 ...
                 <li>
                     <a href="javascript: void(0);" class="dropdown-item">
                         <span class="avatar avatar-circle avatar-xxs"><img class="avatar-img"
                                 src="assets/images/flags/1x1/cn.svg" alt="..." width="18" height="18"></span><span
         ...
         <a class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px position-relative link-secondary"
             ...
             <svg viewbox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                 <path d="M10,21.75a2.087,2.087,0,0,0,4.005,0" fill="none" stroke="currentColor" stroke-linecap="round"
                     stroke-linejoin="round" stroke-width="1.5"></path>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Not sure if we'll need any further instruction on how
                                         to utilise the encoded ID in links from the new email broadcast tool.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">This is a notice that an invoice has been generated
                                         on 05/14/2022.</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Hi everyone, thanks to all who have already signed
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Let's see how your emails performed in the past
                                         week.</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">I wanted to introduce Alan to you all, who starts
                                         today in the Operations Team as our new Global Payroll & Benefits
                                         Manager.</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Good morning Brian, I hope you can help with the
                                         following. I am looking for somebody who can help us create stronger
                                         newsletters.</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Please note that it may take a little while for this
                                         payment to appear in the Activity section of your account.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Welcome to CookieYes! Thank you for creating an
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Thank you so much for continuing to leave no stone
                                         unturned in pursuit of new milestones of success.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Our office will be closed on these days, as it will
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">We have updated our external meeting and events
                                         protocol. Please have a look at the office board.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Happy with your product or service? Sign up for the
                                         IONOS Referral Program to recommend us to your business partners, friends or
                                         family. We'll reward you with attractive commissions when they place an
                                         order.</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Please add video overlay option to microsite header
                                         image</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">[JIRA] (WEB-1022) Add Full Width Video Content Block
                                         to microsites</small>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Your hard drive is close to its storage cap. Once
                                         exceeded, you can't add new items or sync changes.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Login to your Rave account to place your order and
                                         you will automatically earn double points on every $ spent.</small>
                                 </div>
                             </div>
                         </div>
                     </a>
                         ...
                         <div class="d-flex">
                             ...
                             <div class="d-flex flex-column flex-grow-1">
                                 ...
                                 <div class="d-flex flex-column">
                                     ...
                                     <small class="text-secondary">Improving slide arrows and indicators on gift impact,
             ...
             <a href="javascript: void(0);"
                 ...
                 <svg viewbox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                     <path d="M8.250 12.000 A3.750 3.750 0 1 0 15.750 12.000 A3.750 3.750 0 1 0 8.250 12.000 Z"
                         fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                         stroke-width="1.5"></path>
                     <path d="M17.119 20.301L12.529 15.711" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                     <path d="M15.711 12.53L20.301 17.119" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                     <path d="M3.699 17.119L8.289 12.529" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                     <path d="M11.471 15.712L6.881 20.301" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                     ...
                     <path d="M8.289 11.471L3.699 6.881" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                     <path d="M20.301 6.881L15.711 11.471" fill="none" stroke="currentColor" stroke-linecap="round"
                         stroke-linejoin="round" stroke-width="1.5"></path>
                             ...
                             <a href="javascript: void(0);"
                                 ...
                                 <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                     <svg class="avatar-img mx-auto" viewbox="2.59 0 214.09101008 224"
                                         ...
                                         <lineargradient id="b" x1="114.65" x2="160.81" xlink:href="#a" y1="85.77"
                                             y2="131.92"></lineargradient>
                                         <path
                             ...
                             <a href="javascript: void(0);"
                                 ...
                                 <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                     <svg class="avatar-img mx-auto" viewbox="0 0 100 100" fill="none"
                                         ...
                                         <rect width="100" height="100" fill="#000" fill-opacity="0"></rect>
                                         <circle cx="50" cy="50" r="48" fill="#EA4C89"></circle>
                                 ...
                                 <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                     <svg class="avatar-img mx-auto" viewbox="0 0 512 407.864"
                                         ...
                                         <path
                                             ...
                                             fill="#7952b3" fill-rule="evenodd"></path>
                                     </svg>
                                 </span>
                                 Bootstrap
                             </a>
                             ...
                             <a href="javascript: void(0);"
                                 ...
                                 <span class="avatar avatar-xs d-flex align-items-center mx-auto mb-1">
                                     <svg class="avatar-img mx-auto" xmlns="http://www.w3.org/2000/svg"
                                         ...
                                         <lineargradient id="SVGID_1_" gradientunits="userSpaceOnUse" x1="-277.375"
                                             y1="406.6018" x2="-277.375" y2="407.5726"
                                 ...
                                 <span class="avatar avatar-xs avatar-circle">
                                     <svg class="avatar-img mx-auto" clip-rule="evenodd" fill-rule="evenodd"
                                         ...
                                         <path
                                             ...
                                             fill="#1da1f2" fill-rule="nonzero"></path>
                                     </svg>
                                 </span>
                                 Twitter
                             </a>
         ...
         <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCustomize"
             ...
             <div class="offcanvas-body pt-7 pb-5 position-relative">
                 ...
                 <div class="btn-group w-100 mb-7" role="group" aria-label="Light/dark switcher">
                     ...
                     <label class="btn btn-outline-primary px-3 w-100 d-flex align-items-center justify-content-center"
                         for="lightMode">
                         <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" class="me-2" height="18"
                             width="18">
                             <g>
                             ...
                             <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" class="me-2" height="16"
                                 ...
                                 <g>
                                     <path
                                         ...
                                         style="fill: currentColor"></path>
                                     <rect x="15.5" width="8.5" height="24" rx="2" style="fill: currentColor"></rect>
                                 </g>
                             </svg>
                             RTL Mode
                         </label>
         ...
         <div class="dropdown">
             <a href="javascript: void(0);"
                 ...
                 <div class="avatar avatar-circle avatar-sm avatar-online">
                     ...
                     @if(Auth::user()?->upload)
                     <img src=" {{ asset('storage/uploads/'.Auth::user()->upload) }}" alt="profil" width="40"
                         height="40" class="rounded-circle" style="object-fit:cover;">
                     @else
                     <div class="avatar- avatar-circle avatar-sm upload-default ">
