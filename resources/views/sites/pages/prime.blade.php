...
@section('content')
    ...
    <style>
        ...
        :root {
            ...
            /* ── Gris de l'image (fond principal) ── */
            --grey-bg:          #D3D3D3;   /* gris clair de l'affiche */
            --grey-mid:         #BEBEBE;   /* séparateurs, bordures */
            --grey-dark:        #9E9E9E;   /* textes secondaires sur gris */
            --grey-panel:       #C4C4C4;   /* panneaux légèrement plus foncés */
            --grey-card:        #CACACA;   /* cards sur fond gris */
            --on-grey:          #1A2744;   /* texte principal sur fond gris = navy */
            --on-grey-muted:    #5C5C5C;   /* texte secondaire sur fond gris */
        }
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .primes-hero {
            position: relative;
            min-height: 72vh;
            /* Gris de l'image avec des reflets subtils terracotta/or */
        ...
        /* Glows colorés discrets sur fond gris */
        .primes-hero::before {
            content: '';
            position: absolute;
            inset: 0;
        ...
        .hero-pill i { color: var(--terracotta); font-size: 13px; }
        ...
        .deco-date {
            font-family: 'Bebas Neue', sans-serif;
            font-size: 13px; letter-spacing: 4px; color: var(--terracotta);
        }
        ...
        .deco-divider {
            height: 1px;
            background: linear-gradient(to right, var(--terracotta), var(--gold), transparent);
        }
        ...
        {{-- <div class="hero-inner"> --}}
            ...
            {{-- <div class="hero-deco">
                ...
                <div class="hero-deco-card">
                    ...
                    <div class="deco-venue">Akpakpa — Salle des fêtes St Charbel<br>
                        <small style="font-size:13px;color:var(--on-grey-muted);font-style:normal;">À côté de l'Hôtel du Lac</small>
                    </div>
