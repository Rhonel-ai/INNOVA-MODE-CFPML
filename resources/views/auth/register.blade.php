        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-7 col-lg-6 px-lg-4 px-xl-8 d-flex flex-column vh-100 py-6">
                ...
                <a class="navbar-brand mb-auto" href="index-1.html">
                    <img src="{{ asset('admin/assets/js/theme.bundle-1.jsassets/images/logo-1.svg') }}"
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="agree">
                                I agree with <a href="javascript: void(0);">Terms & Conditions</a> and have understood
                                <a href="javascript: void(0);">Privacy Policy</a>
                            </label>
                        </div>

                        <!-- Button -->
                        <button type="submit" class="btn btn-primary mt-3" id="password-confirm" type="password"
            ...
            <div class="col-md-5 col-lg-6 d-none d-lg-block">
                ...
                <div class="bg-size-cover bg-position-center bg-repeat-no-repeat overlay overlay-dark overlay-50 vh-100 me-n4"
                    style="background-image: url({{ asset('admin/assets/images/covers/sign-up-cover-1.jpeg') }});">
                </div>
            </div>
        </div> <!-- / .row -->
    </main> <!-- / main -->
    <script src="{{ asset('admin/assets/js/theme.bundle-1.js') }}"></script>
