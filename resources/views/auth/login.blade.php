        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-md-7 col-lg-6 px-lg-4 px-xl-8 d-flex flex-column vh-100 py-6">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <!-- Input -->
                                    <input class="form-control" placeholder="Your email address" id="email" type="email"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" class="form-control" data-toggle-password-input=""
                ...
                <div class="mt-auto">
                    ...
                    <small class="mb-0 text-body-secondary">
                        ...
                        Forgot password? <a href="{{ route('password.request') }}" class="fw-semibold">Forgot
                            password?</a>
                    </small>
            ...
            <div class="col-md-5 col-lg-6 d-none d-lg-block">
                ...
                <div class="bg-size-cover bg-position-center bg-repeat-no-repeat overlay overlay-dark overlay-50 vh-100 me-n4"
                    style="background-image: url({{asset('admin/assets/images/covers/sign-in-cover-1.jpeg')}}); background-image: url({{ asset('admin/assets/images/covers/sign-in-cover-1.jpeg')}});">
                </div>
            </div>
        </div> <!-- / .row -->
    </main> <!-- / main -->
